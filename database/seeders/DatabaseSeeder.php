    ...
    public function run(): void
    {
        ...
        $reviews = [
            [
                ...
                'contribution_to_knowledge_decision' => 'Yes', 
                'technical_soundness_decision' => 'Yes', 
                'comprehensive_subject_matter_decision' => 'Yes', 
                'applicable_and_sufficient_references_decision' => 'Yes', 
                'inappropriate_references_decision' => 'Yes', 
                'comprehensive_application_decision' => 'Yes', 
                'grammar_and_presentation_decision' => 'Yes', 
                'assumption_of_reader_knowledge_decision' => 'Yes', 
                'clear_figures_and_tables_decision' => 'Yes', 
                'adequate_explanations_decision' => 'Yes', 
                'technical_or_methodological_errors_decision' => 'Yes', 

                'contribution_to_knowledge_comments' => 'The paper significantly contributes to the existing body of knowledge in the field.',
                'technical_soundness_comments' => 'The paper demonstrates a high level of technical soundness.',
                'comprehensive_subject_matter_comments' => 'The subject matter is presented comprehensively, covering all relevant aspects and providing a clear understanding of the topic.',
                'applicable_and_sufficient_references_comments' => 'The references are both relevant and sufficient, supporting the claims and arguments made in the paper.',
                'inappropriate_references_comments' => 'No, all references are appropriate and directly related to the topic under discussion.',
                'comprehensive_application_comments' => 'The application described in the paper is comprehensive and well-detailed, making it easy to replicate or implement.',
                'grammar_and_presentation_comments' => 'The grammar and presentation are generally good, with only minor issues that do not significantly impact the paper-s overall quality.',
                'assumption_of_reader_knowledge_comments' => 'The submission is indeed highly technical, but it does not assume excessive prior knowledge, as it provides adequate explanations for complex concepts.',
                'clear_figures_and_tables_comments' => 'The figures and tables are clear and enhance the reader-s understanding of the content, making them easy to interpret.',
                'adequate_explanations_comments' => 'The explanations provided throughout the paper are adequate, ensuring that readers can follow the author-s reasoning and methodology.',
                'technical_or_methodological_errors_comments' => 'There are no major technical or methodological errors in the paper. The research design and methodology are robust and well-executed.',
            ...
            [
                ...
                'contribution_to_knowledge_decision' => 'No', 
                'technical_soundness_decision' => 'No', 
                'comprehensive_subject_matter_decision' => 'No', 
                'applicable_and_sufficient_references_decision' => 'No', 
                'inappropriate_references_decision' => 'No', 
                'comprehensive_application_decision' => 'No', 
                'grammar_and_presentation_decision' => 'No', 
                'assumption_of_reader_knowledge_decision' => 'No', 
                'clear_figures_and_tables_decision' => 'No', 
                'adequate_explanations_decision' => 'No', 
                'technical_or_methodological_errors_decision' => 'No', 

                'contribution_to_knowledge_comments' => 'Yes, the paper makes a valuable contribution to the existing body of knowledge by presenting innovative findings in the field.',
                'technical_soundness_comments' => 'The paper demonstrates a high level of technical competence and rigor, ensuring the reliability of the presented results.',
                'comprehensive_subject_matter_comments' => 'The subject matter is presented comprehensively, covering all relevant aspects and providing a clear context for the research.',
                'applicable_and_sufficient_references_comments' => 'The references are both applicable and sufficient, supporting the research and providing additional resources for readers.',
                'inappropriate_references_comments' => 'All references appear to be relevant to the topic, and there are no inappropriate citations.',
                'comprehensive_application_comments' => 'The application is comprehensive and well-detailed, offering a thorough understanding of how the research can be applied in real-world scenarios.',
                'grammar_and_presentation_comments' => 'The grammar and presentation are acceptable, although there are some minor issues that could be improved.',
                'assumption_of_reader_knowledge_comments' => 'The submission is quite technical, and it assumes a high level of reader knowledge. Providing more explanations for complex concepts would enhance accessibility.',
                'clear_figures_and_tables_comments' => 'Figures and tables are clear and well-labeled, making it easy to interpret the data and results.',
                'adequate_explanations_comments' => 'Explanations are generally adequate, but in some sections, additional clarification would enhance reader understanding.',
                'technical_or_methodological_errors_comments' => 'No significant technical or methodological errors were identified in the paper. The research methods are robust',
            ...
            [
                ...
                'contribution_to_knowledge_comments' => 'Yes, the paper makes a significant contribution to the existing body of knowledge in the field.',
                'technical_soundness_comments' => 'Yes, the paper is technically sound and well-researched.',
                'comprehensive_subject_matter_comments' => 'The subject matter is presented comprehensively, covering all essential aspects.',
                'applicable_and_sufficient_references_comments' => 'The references cited in the paper are relevant and provide a strong foundation for the research.',
                'inappropriate_references_comments' => 'All references seem appropriate and relevant to the topic being discussed.',
                'comprehensive_application_comments' => 'The application described in the paper is comprehensive and well-explained.',
                'grammar_and_presentation_comments' => 'The paper-s grammar and presentation are satisfactory, but some minor proofreading is recommended for further improvement.',
                'assumption_of_reader_knowledge_comments' => 'The paper may assume some prior knowledge, which could make it less accessible to readers without a deep understanding of the field.',
                'clear_figures_and_tables_comments' => 'The figures and tables are clear and enhance the understanding of the content.',
                'adequate_explanations_comments' => 'The explanations provided in the paper are generally clear and adequate, but there are a few areas where further clarification would be beneficial.',
                'technical_or_methodological_errors_comments' => 'There are no significant technical or methodological errors detected in the paper.',
            ...
            [
                ...
                'contribution_to_knowledge_comments' => 'The paper-ss findings and insights add valuable information to the subject matter.',
                'technical_soundness_comments' => 'The methodology and experiments conducted in the paper are robust and well-executed.',
                'comprehensive_subject_matter_comments' => 'The paper provides a thorough and well-organized overview of the topic.',
                'applicable_and_sufficient_references_comments' => 'While the references are generally good, a few more recent sources could be included.',
                'inappropriate_references_comments' => 'All references seem appropriate and relevant to the topic being discussed.',
                'comprehensive_application_comments' => 'It covers various aspects and potential use cases effectively.',
                'grammar_and_presentation_comments' => 'The paper-s grammar and presentation are satisfactory, but some minor proofreading is recommended for further improvement.',
                'assumption_of_reader_knowledge_comments' => 'The paper may assume some prior knowledge, which could make it less accessible to readers without a deep understanding of the field.',
                'clear_figures_and_tables_comments' => 'The visuals aid in conveying information effectively.',
                'adequate_explanations_comments' => 'The explanations provided in the paper are generally clear and adequate, but there are a few areas where further clarification would be beneficial.',
                'technical_or_methodological_errors_comments' => 'it is well-executed.',
            ...
            [
                ...
                'contribution_to_knowledge_decision' => null, 
                'technical_soundness_decision' => null, 
                'comprehensive_subject_matter_decision' => null, 
                'applicable_and_sufficient_references_decision' => null, 
                'inappropriate_references_decision' => null, 
                'comprehensive_application_decision' => null, 
                'grammar_and_presentation_decision' => null, 
                'assumption_of_reader_knowledge_decision' => null, 
                'clear_figures_and_tables_decision' => null, 
                'adequate_explanations_decision' => null, 
                'technical_or_methodological_errors_decision' => null, 

                'contribution_to_knowledge_comments' => null,
                'technical_soundness_comments' => null,
                'comprehensive_subject_matter_comments' => null,
                'applicable_and_sufficient_references_comments' => null,
                'inappropriate_references_comments' => null,
                'comprehensive_application_comments' => null,
                'grammar_and_presentation_comments' => null,
                'assumption_of_reader_knowledge_comments' => null,
                'clear_figures_and_tables_comments' => null,
                'adequate_explanations_comments' => null,
                'technical_or_methodological_errors_comments' => null,
            ...
            [
                ...
                'contribution_to_knowledge_comments' => ' The paper makes a significant contribution to the field by providing new insights into project name.',
                'technical_soundness_comments' => 'The paper demonstrates a high level of technical competence and rigor.',
                'comprehensive_subject_matter_comments' => 'The subject matter is presented comprehensively, covering all key aspects of [research_project_name].',
                'applicable_and_sufficient_references_comments' => 'The references provided are relevant and sufficient to support the research findings.',
                'inappropriate_references_comments' => 'All references appear relevant to the topic, and there are no irrelevant citations.',
                'comprehensive_application_comments' => 'The application of the research is thorough and comprehensive, addressing all key aspects of [research_project_name].',
                'grammar_and_presentation_comments' => 'The grammar and presentation are acceptable, with only minor issues that do not significantly impact the overall quality of the paper.',
                'assumption_of_reader_knowledge_comments' => 'The technical nature of the submission is well-justified and does not assume an excessive level of prior knowledge.',
                'clear_figures_and_tables_comments' => 'Figures and tables are well-organized, clear, and aid in understanding the research.',
                'adequate_explanations_comments' => 'Explanations provided in the paper are clear, concise, and effectively convey the research concepts.',
                'technical_or_methodological_errors_comments' => 'No significant technical or methodological errors were identified in the paper.',
            ...
            [
                ...
                'contribution_to_knowledge_comments' => 'The paper makes a significant contribution to the existing body of knowledge in the field. It offers a fresh perspective on the subject matter and presents valuable insights that can advance the understanding of the topic.',
                'technical_soundness_comments' => 'Yes, the paper demonstrates a high level of technical soundness. The methodology and experiments conducted are well-structured and rigorously executed.',
                'comprehensive_subject_matter_comments' => 'The subject matter is presented comprehensively, covering all essential aspects of the topic. The paper provides a thorough analysis and discussion.',
                'applicable_and_sufficient_references_comments' => 'The references are both relevant and sufficient for supporting the paper\'s claims. The paper draws on a well-rounded set of sources to substantiate its arguments.',
                'inappropriate_references_comments' => 'No, all the references cited in the paper are directly relevant to the topic under discussion. There are no references that appear out of place.',
                'comprehensive_application_comments' => 'The application presented in the paper is comprehensive, addressing a wide range of practical scenarios and potential use cases. It demonstrates a strong understanding of real-world applications.',
                'grammar_and_presentation_comments' => 'The grammar and presentation are generally of good quality, though there are a few minor errors. These do not significantly detract from the overall readability and understanding of the paper.',
                'assumption_of_reader_knowledge_comments' => 'The paper is indeed highly technical, but the author has done a commendable job in providing adequate explanations and context, ensuring that it is accessible even to readers with a moderate level of technical knowledge.',
                'clear_figures_and_tables_comments' => 'The figures and tables are well-organized and presented clearly, aiding in the understanding of the content. They enhance the overall quality of the paper.',
                'adequate_explanations_comments' => 'The explanations provided in the paper are comprehensive and leave little room for ambiguity. They effectively convey complex concepts to the reader.',
                'technical_or_methodological_errors_comments' => 'No significant technical or methodological errors were identified in the paper. The research methodology appears robust and well-executed.',
            ...
            [
                ...
                'contribution_to_knowledge_comments' => 'Yes, the paper makes a valuable contribution to the existing body of knowledge by providing novel insights and findings.',
                'technical_soundness_comments' => 'The paper is technically sound and demonstrates a strong understanding of the subject matter.',
                'comprehensive_subject_matter_comments' => 'The subject matter is presented comprehensively, covering all relevant aspects and providing a clear understanding of the topic.',
                'applicable_and_sufficient_references_comments' => 'The references provided are both applicable and sufficient to support the claims and arguments made in the paper.',
                'inappropriate_references_comments' => 'No, all references appear to be relevant and appropriate for the topic.',
                'comprehensive_application_comments' => 'The application is comprehensive and well-documented, ensuring that readers can understand and replicate the work.',
                'grammar_and_presentation_comments' => 'While the grammar and presentation could be improved in some areas, it does not significantly detract from the overall quality of the paper.',
                'assumption_of_reader_knowledge_comments' => 'The paper assumes a moderate level of technical knowledge, but it could benefit from providing more explanations for readers with less expertise in the field.',
                'clear_figures_and_tables_comments' => 'The figures and tables are clear, well-labeled, and enhance the understanding of the content.',
                'adequate_explanations_comments' => 'The explanations provided are generally adequate, but there are a few sections where more detailed explanations would improve clarity.',
                'technical_or_methodological_errors_comments' => 'No technical or methodological errors were identified in the paper; it is well-executed.',
