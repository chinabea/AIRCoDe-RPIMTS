@if(Auth::check())
    @if(Auth::user()->role == 1 || Auth::user()->role == 2 || Auth::user()->role == 3)
      ...
      <div id="project-team-form" class="mt-4" style="display: none;">
        ...
        @if(Auth::user()->role == 1)
            <!-- Display this content for role 1 -->
            <p>Show this for role 1</p>
        @elseif(Auth::user()->role == 2)
            <!-- Display this content for role 2 -->
            <p>Show this for role 2</p>
        @endif
    ...
    @elseif(Auth::user()->role == 1 || Auth::user()->role == 2)
      ...
      <div class="col-md-12">
        ...
        @if(Auth::user()->role == 3)
            <!-- Display this content for role 3 -->
            <p>Show this for role 3</p>
        @elseif(Auth::user()->role == 4)
            <!-- Display this content for role 4 -->
            <p>Show this for role 4</p>
        @endif
